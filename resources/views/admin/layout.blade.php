...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color:#719c51 !important;">
    ...
    <a href="" class="brand-link">
      <img src="{{ asset('adminlte/img/logo_participacion2.jpg') }}" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
      <span class="brand-text font-weight-bold" style="color: white;">Consulta</span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
          <a href="#" class="d-block" style="color: white !important;">Bienvenido</a>
        </div>
      </div>
  ...
  <div class="content-wrapper" style="background-color:#ddedbd !important;">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Consulta de Subsidio Económico</h1>
          </div><!-- /.col -->
          <!-- <div class="col-sm-6">
  ...
  <footer class="main-footer">
    ...
    <!-- Default to the left -->
    <strong>Copyright &copy; 2020 <a href="#"> Consulta</a>.</strong> Todos los derechos reservados.
  </footer>
</div>
<!-- ./wrapper -->
